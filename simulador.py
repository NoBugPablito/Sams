...
[data-testid="stDataFrame"] { border: 1px solid #1f2330; border-radius: 10px; }
h1, h2, h3 { color: #f0ede8 !important; font-family: 'Space Grotesk', sans-serif !important; }
p, li { color: #9a9a95; }
strong { color: #d8d5d0 !important; }
...
# Diccionario de Albergues / Zonas Seguras Oficiales por Comuna
albergues_biobio = {
...
# ==============================================================================
# 2. CARGA Y LIMPIEZA DE DATOS AUTOMATIZADA
# ==============================================================================
@st.cache_data
def inicializar_sistema():
    # A. Datos geográficos de comunas
...
try:
    ...
    st.error(f"❌ Error crítico en la carga de datasets locales: {e}")
    st.stop()
...
# ==============================================================================
# 5. ESTRUCTURA DE PESTAÑAS (UX OPTIMIZADA)
# ==============================================================================
...
# ------------------------------------------------------------------------------
# PESTAÑA 3: DESCARGA DE RESULTADOS CORREGIDA PARA EXCEL EN ESPAÑOL
# ------------------------------------------------------------------------------
with tab_datos:
    ...
    # SOLUCIÓN: Usar separador punto y coma (sep=';') y codificación 'utf-8-sig' para correcta lectura en Excel España/Chile
